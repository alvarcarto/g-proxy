...
// Factory function to create a new route to reduce boilerplate in express handlers
...
// Route which assumes that the `func` returns a promise which resolves with a JSON serializable
// data
...
function createRequestLogger(req) {
  return createLogger(`request:${req.id}`)
}
